...
#-------------------------------passsword generator according to user input---------------------------
...
# teacher6 = Teacher(teacherName="Hari Khadka", subject= "Health", address="Banepa")
# teacher7 = Teacher(teacherName="Anil Karki", subject= "Computer", address="Hetauda")
# teacher8 = Teacher(teacherName="Ram Karki", subject= "Account", address="Janakpur")
...
#Write a python program to create a class Laptop with properties [id, name, ram] and create 3 objects of it and print all details. wappalyzer

#-----------------todoList.py-------------------------------------------
def taskList(): #i create a function name taskList
    todoList =[] #empty variable with list data type, user will add data in this list
    ...
    for i in range(1, todoCount+1): #using loop to enter the number of task entered by user (started from 1 and added +1  because default value is 0)
        ...
        print(f"The Task {task} Has Been Added To Your Todo List.")
